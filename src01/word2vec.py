...
model = word2vec.Word2Vec(sentences, vector_size=3, sg=1)
model.save("model/word2vec-RGB.model")

with open("color_vec/lists/color_rgb_word2vec.txt", "w", encoding="utf-8") as f:
